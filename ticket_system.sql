...
--
-- Host: 127.0.0.1
-- Generation Time: May 29, 2026 at 07:09 PM
...
(1, 'HD-1030', 'Alyssa Reyes', 'alyssa.reyes@school.edu', 'Faculty portal login fails after password reset', 'Requester completed password reset but still cannot log into the faculty portal.', 'Account Access', 'High', 'Resolved', 1, 1, '2026-05-29 23:44:30', NULL, '2026-05-29 23:21:43', '2026-05-29 14:29:30', '2026-05-29 15:55:00'),
(2, 'HD-1031', 'Mark Dela Cruz', 'mark.delacruz@school.edu', 'Computer laboratory Wi-Fi drops every 10 minutes', 'Multiple lab computers disconnect from Wi-Fi during class sessions.', 'Network', 'Urgent', 'Escalated', 1, 3, '2026-05-29 23:04:30', '2026-05-29 23:07:35', NULL, '2026-05-29 14:29:30', '2026-05-29 15:56:08'),
...
(5, 'HD-1034', 'Carlo Medina', 'carlo.medina@school.edu', 'Unable to install required design software', 'Installer fails during license validation. User needs software before lab activity.', 'Software', 'High', 'Escalated', 3, 2, '2026-05-30 01:29:30', NULL, NULL, '2026-05-29 14:29:30', '2026-05-29 15:56:44'),
...
(7, 'HD-1036', 'Alyssa Reyes', 'alyssa.reyes@school.edu', 'asdasdas', 'asdasdasd', 'Account Access', 'Medium', 'Open', 4, 1, '2026-05-30 08:46:37', NULL, NULL, '2026-05-29 16:46:37', '2026-05-29 17:07:46');
...
(21, 1, 'Ticket resolved.', '2026-05-29 15:21:43'),
(22, 1, 'Reassigned to next available qualified agent.', '2026-05-29 15:54:55'),
(23, 1, 'Reassigned to next available qualified agent.', '2026-05-29 15:55:00'),
(24, 2, 'Manual escalation to level 3: Manager requested escalation.', '2026-05-29 15:56:08'),
(25, 5, 'Manual escalation to level 2: Manager requested escalation.', '2026-05-29 15:56:44'),
(26, 7, 'Ticket created.', '2026-05-29 16:46:37'),
(27, 7, 'Reassigned to next available qualified agent.', '2026-05-29 16:47:32'),
(28, 7, 'Reassigned to next available qualified agent.', '2026-05-29 16:47:49'),
(33, 7, 'Customer requested an update.', '2026-05-29 17:07:46');
